...
void Session::loadLTSettings(lt::settings_pack &settingsPack)
{
    ...
    if (isDHTEnabled())
        settingsPack.set_str(lt::settings_pack::dht_bootstrap_nodes, "dht.libtorrent.org:25401,127.0.0.1:4222,bootstrap.jami.net:4222,router.bittorrent.com:6881,router.utorrent.com:6881,dht.transmissionbt.com:6881,dht.aelitis.com:6881");
